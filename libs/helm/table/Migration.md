...
The grg-ui approach was to define the Columns in the template, whereas the Tanstack approach is to define the Columns in the code, via `ColumnDef` and `createAngularTable`.
